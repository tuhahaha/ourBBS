...
<head>
	...
	<script LANGUAGE="JavaScript"> //调用JavaScript方法   
        function article_post(){       
          var head = document.getElementById("mymessage_head").value;  //获取值.
          var body = document.getElementById("mymessage_body").value;  //获取值.   
          location.href="home_article.jsp?article_head="+head+"&article_body="+body;  //  链接跳转
        }
    </script>
</head>
		...
		<div class="row clearfix">
			...
			<div class="col-md-9 column">
				<div class="send_message">
					...
					style="background-color:7fffd4;width:50px;height:30px;float:right;border-radius:5px;"
					onclick="article_post()">发布</button>
				</div>
